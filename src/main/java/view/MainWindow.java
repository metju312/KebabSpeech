...
public class MainWindow extends JFrame {
    ...
    private void initDatabaseTemplates(){
        ...
        IngredientTemplate i1 = addIngredientTemplate("Baranina", 2.4f, null);
        IngredientTemplate i2 = addIngredientTemplate("Kurczak", 2f, null);
        IngredientTemplate i3 = addIngredientTemplate("Mieszane", 2.2f, null);
        IngredientTemplate i4 = addIngredientTemplate("Tortilla", 2f, null);
        IngredientTemplate i5 = addIngredientTemplate("Bułka", 2f, null);
        IngredientTemplate i6 = addIngredientTemplate("Łagodny", 2f, null);
        IngredientTemplate i7 = addIngredientTemplate("Ostry", 2f, null);
        IngredientTemplate i8 = addIngredientTemplate("Mieszany", 2f, null);
        ...
        ingredientTemplateDao.create(i1);
        ingredientTemplateDao.create(i2);
        ingredientTemplateDao.create(i3);
        ingredientTemplateDao.create(i4);
        ingredientTemplateDao.create(i5);
        ingredientTemplateDao.create(i6);
